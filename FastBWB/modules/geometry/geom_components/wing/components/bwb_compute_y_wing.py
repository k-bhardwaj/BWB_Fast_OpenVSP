...
class ComputeYWingBWB(om.ExplicitComponent):
    """Wing Ys estimation
    Inputs: Wing AR, fusleage max width, wing area, wing kink span ratio.
    Outputs: Wingspan, wing root spanwise position, wingtip spanwise position."""
    ...
    def setup_partials(self):
        ...
        self.declare_partials(
            ...
            ["data:geometry:fuselage:maximum_width"], method="fd"
        )
        self.declare_partials(
    ...
    def compute(self, inputs, outputs):
        ...
        # Wing geometry
        y4_wing = span / 2.0 # Check Preliminary Design Manual, wing geometry.
        y2_wing = width_max / 2.0
        #y3_wing = y4_wing * 0.25 ## 
        y3_wing = np.maximum(y2_wing, y4_wing * wing_break)
        #print("Span value in bwb_compute_y_wing.py:", span)
