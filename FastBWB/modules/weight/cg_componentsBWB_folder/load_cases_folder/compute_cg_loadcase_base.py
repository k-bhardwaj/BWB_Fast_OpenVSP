...
------------------------------------------
This file calculates the CG ratio with payload (cg_ratio_aircraft_with_payload
) based on the function _get_payload_mass_and_cg() which returns the variables
"mass_payload", "x_cg_payload".
