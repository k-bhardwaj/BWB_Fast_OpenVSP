"""
Estimation of wing center of gravity (CG_A1)
------------------------------------------
Depends on wing break parameter.
...
from ..constantscg import SERVICE_WING_CG


@RegisterSubmodel(SERVICE_WING_CG, "fastoad.submodel.weight.cg.wing.BWBtest.1")
