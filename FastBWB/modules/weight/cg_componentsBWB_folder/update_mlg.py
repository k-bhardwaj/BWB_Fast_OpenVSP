"""
Estimation of main landing gear center of gravity (CG_A51)
------------------------------------------
This file calculates the CG of the main landing gear.
...
from ..constantscg import SERVICE_MLG_CG


@RegisterSubmodel(SERVICE_MLG_CG, "fastoad.submodel.weight.cg.mlg.BWBtest.1")
