...
------------------------------------------------------
This function computes empty masses, CG and MAC position taking into account
all the masses computed (airframe, systems, furniture, propulsion)
...
from ..constantscg import SERVICE_EMPTY_AIRCRAFT_CG


@RegisterSubmodel(SERVICE_EMPTY_AIRCRAFT_CG, "fastoad.submodel.weight.cg.empty_aircraft.BWBtest.1")
