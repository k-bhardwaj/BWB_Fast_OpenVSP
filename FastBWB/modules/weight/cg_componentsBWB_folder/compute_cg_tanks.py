"""
Estimation of tanks center of gravity (x_cg_tank)
------------------------------------------------------
...
from ..constantscg import SERVICE_TANKS_CG


@RegisterSubmodel(SERVICE_TANKS_CG, "fastoad.submodel.weight.cg.tanks.BWBtest.1")
