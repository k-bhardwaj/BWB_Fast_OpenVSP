"""
Estimation of the center of gravity of each component
------------------------------------------------------
Computes CG of airframe,systems, furniture and propulsion components.
...
from ..constantscg import SERVICE_OTHERS_CG


@RegisterSubmodel(SERVICE_OTHERS_CG, "fastoad.submodel.weight.cg.others.BWBtest.1")
