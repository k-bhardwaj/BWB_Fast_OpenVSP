"""
Estimation of life support systems weight - C2 component
---------------------------------------------
- Registered under the name "fastoad.submodel.weight.mass.systems.life_support.BWBtest.1"
Subcomponents mass computed: 
1. C21 = Mass of insulating system
2. C22 = Mass of air conditioning and pressurization system
3. C23 = Mass of de-icing system
4. C24 = Mass of internal lighting system
5. C25 = Mass of seats and installation system
6. C26 = Mass of fixed oxigen 
7. C27 = Mass of permanent security kits
...
@RegisterSubmodel(
    SERVICE_LIFE_SUPPORT_SYSTEMS_MASS, "fastoad.submodel.weight.mass.systems.life_support.BWBtest.1"
)
