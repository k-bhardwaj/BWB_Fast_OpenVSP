"""
Computation of the load cases
----------------------------------------------
This file is in charge of computing the 2 main gust load cases: 
`- Load case 1: with wings with almost no fuel
 - Load case 2: at maximum take-off weight
It is registered under the name "fastoad.submodel.gust_loads.2". 

The function __n_gust() computes a reference gust load. 
"""
...
@RegisterSubmodel(SERVICE_GUST_LOADS, "fastoad.submodel.gust_loads.2")
